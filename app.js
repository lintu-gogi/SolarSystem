...
const solarSystem = [
    ...
    solarSystem.forEach(element => {
        if(element.name==="Neptune"){
            console.log("Neptune moon");
           console.log(element.moons[1]);
        }
    });
    ...
    console.log("Planets With Ringsystem");
    solarSystem.forEach(element => {
        if(element.ringSystem){
    ...
    console.log("Sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune (131) = ");
    ...
    const diff=jupMomentum-pluMomentum;
    console.log("Difference between Jupiter's momentum and Pluto's momentum= "+diff);